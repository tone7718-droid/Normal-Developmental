...
export const pick = <T,>(v: { ko: T; en: T }, lang: Lang): T => v[lang];
...
export const stages: Stage[] = [
  {
    id: "0-1",
    ageRange: { ko: "0–1개월", en: "0–1 months" },
    shortAge: { ko: "신생아", en: "Newborn" },
    emoji: "👶",
    theme: "rose",
    summary: {
  ...
  {
    id: "2",
    ageRange: { ko: "2개월", en: "2 months" },
    shortAge: { ko: "2개월", en: "2 months" },
    emoji: "🙂",
    theme: "amber",
    summary: {
  ...
  {
    id: "3-4",
    ageRange: { ko: "3–4개월", en: "3–4 months" },
    shortAge: { ko: "3–4개월", en: "3–4 months" },
    emoji: "🤲",
    theme: "emerald",
    summary: {
  ...
  {
    id: "5-6",
    ageRange: { ko: "5–6개월", en: "5–6 months" },
    shortAge: { ko: "5–6개월", en: "5–6 months" },
    emoji: "🔄",
    theme: "sky",
    summary: {
  ...
  {
    id: "7-8",
    ageRange: { ko: "7–8개월", en: "7–8 months" },
    shortAge: { ko: "7–8개월", en: "7–8 months" },
    emoji: "🧎",
    theme: "violet",
    summary: {
  ...
  {
    id: "9-10",
    ageRange: { ko: "9–10개월", en: "9–10 months" },
    shortAge: { ko: "9–10개월", en: "9–10 months" },
    emoji: "🚼",
    theme: "teal",
    summary: {
  ...
  {
    id: "11-12",
    ageRange: { ko: "11–12개월", en: "11–12 months" },
    shortAge: { ko: "돌 무렵", en: "Around 1 year" },
    emoji: "🧍",
    theme: "fuchsia",
    summary: {
  ...
  {
    id: "13-18",
    ageRange: { ko: "13–18개월", en: "13–18 months" },
    shortAge: { ko: "13–18개월", en: "13–18 months" },
    emoji: "🚶",
    theme: "indigo",
    summary: {
  ...
  {
    id: "19-24",
    ageRange: { ko: "19–24개월", en: "19–24 months" },
    shortAge: { ko: "두 돌 무렵", en: "Around 2 years" },
    emoji: "🏃",
    theme: "rose",
    summary: {
...
export const reflexes: Reflex[] = [
  {
    id: "moro",
    name: { ko: "모로 반사", en: "Moro Reflex" },
    englishName: "Moro · Startle",
    emoji: "😲",
    appears: { ko: "출생 시", en: "At birth" },
    disappears: { ko: "보통 4–6개월에 사라짐", en: "Usually fades by 4–6 months" },
    appearsMonth: 0,
    disappearsMonth: 5,
    whatHappens: {
  ...
  {
    id: "rooting",
    name: { ko: "찾기(포유) 반사", en: "Rooting Reflex" },
    englishName: "Rooting",
    emoji: "🍼",
    appears: { ko: "출생 시", en: "At birth" },
    disappears: { ko: "보통 4개월경 사라짐", en: "Usually fades around 4 months" },
    appearsMonth: 0,
    disappearsMonth: 4,
    whatHappens: {
  ...
  {
    id: "sucking",
    name: { ko: "빨기 반사", en: "Sucking Reflex" },
    englishName: "Sucking",
    emoji: "👄",
    appears: { ko: "출생 전(임신 32주경)부터", en: "Before birth (around 32 weeks)" },
    disappears: { ko: "점차 의식적인 빨기로 전환", en: "Gradually becomes voluntary sucking" },
    appearsMonth: 0,
    disappearsMonth: 4,
    whatHappens: {
  ...
  {
    id: "grasp",
    name: { ko: "쥐기(파악) 반사", en: "Palmar Grasp Reflex" },
    englishName: "Palmar Grasp",
    emoji: "✊",
    appears: { ko: "출생 시", en: "At birth" },
    disappears: { ko: "보통 5–6개월에 사라짐", en: "Usually fades by 5–6 months" },
    appearsMonth: 0,
    disappearsMonth: 6,
    whatHappens: {
  ...
  {
    id: "stepping",
    name: { ko: "걷기(보행) 반사", en: "Stepping Reflex" },
    englishName: "Stepping",
    emoji: "👣",
    appears: { ko: "출생 시", en: "At birth" },
    disappears: { ko: "보통 2개월경 사라짐", en: "Usually fades around 2 months" },
    appearsMonth: 0,
    disappearsMonth: 2,
    whatHappens: {
  ...
  {
    id: "babinski",
    name: { ko: "바빈스키 반사", en: "Babinski Reflex" },
    englishName: "Babinski",
    emoji: "🦶",
    appears: { ko: "출생 시", en: "At birth" },
    disappears: { ko: "보통 12–24개월에 사라짐", en: "Usually fades by 12–24 months" },
    appearsMonth: 0,
    disappearsMonth: 24,
    whatHappens: {
...
export const checkups: Checkup[] = [
  {
    period: { ko: "1차", en: "1st" },
    ageLabel: { ko: "생후 14–35일", en: "14–35 days" },
    focus: {
      ko: "문진·진찰, 수유·영양 상담",
  ...
  {
    period: { ko: "2차", en: "2nd" },
    ageLabel: { ko: "4–6개월", en: "4–6 months" },
    focus: { ko: "발달 평가 시작, 안전사고 예방 교육", en: "Developmental screening begins, safety education" },
  },
  {
    period: { ko: "3차", en: "3rd" },
    ageLabel: { ko: "9–12개월", en: "9–12 months" },
    focus: { ko: "발달선별검사, 영양·수면 상담", en: "Developmental screening test, nutrition & sleep" },
  },
  {
    period: { ko: "4차", en: "4th" },
    ageLabel: { ko: "18–24개월", en: "18–24 months" },
    focus: { ko: "발달선별검사, 영아 비만·치아 상담", en: "Developmental screening, obesity & dental advice" },
  },
  {
    period: { ko: "5차", en: "5th" },
    ageLabel: { ko: "30–36개월", en: "30–36 months" },
    focus: { ko: "발달선별검사, 사회성·언어 평가", en: "Developmental screening, social & language" },
  },
];
