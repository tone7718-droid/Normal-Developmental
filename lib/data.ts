...
export const reflexes: Reflex[] = [
  ...
  {
    id: "plantar",
    name: { ko: "발바닥 잡기 반사", en: "Plantar Grasp Reflex", vi: "Phản xạ nắm bàn chân" },
    englishName: "Plantar Grasp",
    emoji: "🦶",
    appears: { ko: "출생 시", en: "At birth", vi: "Khi sinh ra" },
    disappears: {
      ko: "보통 9–12개월에 사라짐",
      en: "Usually fades by 9–12 months",
    ...
    whatHappens: {
      ...
      vi: "Ấn vào lòng bàn chân ngay dưới các ngón, các ngón chân sẽ quắp vào trong — giống phiên bản bàn chân của phản xạ nắm tay.",
    },
    howToSee: {
      ko: "발가락 밑동을 손가락으로 살짝 누르면 발가락이 오므라들어요.",
      en: "Gently press the ball of the foot and the toes curl down.",
      vi: "Ấn nhẹ vào phần gốc các ngón chân, các ngón sẽ quắp xuống.",
    },
    whyItMatters: {
      ko: "이 반사가 통합(사라짐)되어야 발로 바닥을 디디고 서서 걷는 동작이 자연스럽게 발달해요. 보통 잡고 서기·걷기가 시작되는 시기와 맞물려 사라집니다.",
      en: "This reflex must integrate (fade) for standing and walking to develop naturally. It usually fades around the time pulling-up and walking begin.",
      vi: "Phản xạ này phải mất đi thì việc đứng và đi bằng bàn chân mới phát triển tự nhiên. Nó thường mất đi vào khoảng lúc bé bắt đầu bám đứng và tập đi.",
    },
  },
  {
    id: "galant",
    ...
    whatHappens: {
      ...
      vi: "Vuốt dọc một bên cột sống khi bé nằm sấp, hông bé sẽ nghiêng về phía đó, thân uốn thành hình chữ C.",
    },
    howToSee: {
      ko: "엎어 안은 자세에서 등 한쪽을 손가락으로 쓸면 그쪽으로 허리가 살짝 휘어요.",
      en: "Holding baby face-down, stroke one side of the back and the waist curves slightly that way.",
      vi: "Khi bế bé úp, vuốt một bên lưng thì eo bé hơi cong về phía đó.",
    },
    whyItMatters: {
      ko: "양쪽 반응이 대칭인지가 중요해요. 너무 오래 남으면 앉기 자세나 집중에 영향을 줄 수 있어 경과를 봅니다.",
      en: "Symmetry between the two sides matters. If it lingers too long it can affect sitting posture or focus, so its course is watched.",
      vi: "Sự đối xứng giữa hai bên rất quan trọng. Nếu tồn tại quá lâu, nó có thể ảnh hưởng đến tư thế ngồi hoặc khả năng tập trung, nên cần theo dõi.",
    },
  },
  {
    id: "stnr",
    ...
    disappears: {
      ko: "보통 9–11개월에 사라짐",
      en: "Usually fades by 9–11 months",
    ...
    whatHappens: {
      ...
      vi: "Khi cúi đầu, tay co và chân duỗi; khi ngẩng đầu, tay duỗi và chân co. Nó giúp bé tạm thời vào tư thế bò.",
    },
    howToSee: {
      ko: "기기 직전 시기에 네발 자세에서 앞뒤로 흔들거나, 고개 방향에 따라 팔다리가 굽었다 펴지는 모습으로 나타나요.",
      en: "Around the pre-crawling stage, you may see rocking on hands and knees, or the limbs bending/straightening with head direction.",
      vi: "Quanh giai đoạn trước khi bò, bạn có thể thấy bé đung đưa trên tay và đầu gối, hoặc tay chân co duỗi theo hướng đầu.",
    },
    whyItMatters: {
      ko: "잠깐 나타났다 사라지는 '전환기' 반사예요. 적절히 통합되어야 손과 무릎을 번갈아 쓰는 교대 기기로 넘어갑니다.",
      en: "A transient 'bridging' reflex that appears then fades. It must integrate properly for reciprocal (alternating) crawling to develop.",
      vi: "Một phản xạ 'bắc cầu' thoáng qua rồi mất đi. Nó phải mất đi đúng cách thì kiểu bò luân phiên (xen kẽ tay-chân) mới phát triển.",
    },
  },
  {
    id: "tlr",
    ...
    appears: { ko: "출생 시", en: "At birth", vi: "Khi sinh ra" },
    disappears: {
      ko: "점차 통합돼 약 4–6개월에 약해짐",
      en: "Gradually integrates, weakening by about 4–6 months",
    ...
    whatHappens: {
      ...
      vi: "Ngả đầu ra sau làm toàn thân duỗi; cúi đầu về trước làm toàn thân cuộn lại. Vị trí đầu ảnh hưởng đến trương lực toàn thân.",
    },
    howToSee: {
      ko: "자세를 바꿀 때 몸이 통째로 뻣뻣하게 펴지거나 굽는 경향으로 관찰돼요. 시간이 지나며 점점 약해집니다.",
      en: "Seen as a tendency for the whole body to stiffly extend or curl when position changes. It weakens over time.",
      vi: "Thấy ở xu hướng toàn thân cứng duỗi hoặc cuộn lại khi đổi tư thế. Nó yếu dần theo thời gian.",
    },
    whyItMatters: {
      ko: "이 반사가 약해져야 머리를 몸과 따로 움직이고, 뒤집기·앉기 같은 항중력 자세 조절이 발달해요.",
      en: "This reflex must weaken so the head can move independently of the body, allowing antigravity control like rolling and sitting to develop.",
      vi: "Phản xạ này phải yếu đi thì đầu mới cử động độc lập với thân, cho phép kiểm soát kháng trọng lực như lật và ngồi phát triển.",
    },
  },
];
